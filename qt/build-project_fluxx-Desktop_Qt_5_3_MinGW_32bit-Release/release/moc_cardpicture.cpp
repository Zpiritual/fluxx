...
#include "../../project_fluxx/cardpicture.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CardPicture_t, stringdata) + ofs \
...
const QMetaObject CardPicture::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CardPicture.data,
      qt_meta_data_CardPicture,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CardPicture.stringdata))
        return static_cast<void*>(const_cast< CardPicture*>(this));
